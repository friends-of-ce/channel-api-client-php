...
/**
     ...
     * @return \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReportsResponse
     */
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReportsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function settlementGetByFilterWithHttpInfo($channelIds = null, $fromStartDate = null, $toStartDate = null, $fromEndDate = null, $toEndDate = null, $fromCreateDate = null, $toCreateDate = null, $fromUpdateDate = null, $toUpdateDate = null, $page = null, string $contentType = self::contentTypes['settlementGetByFilter'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReportsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReportsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReportsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReportsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReportsResponse',
