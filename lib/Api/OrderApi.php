...
/**
     ...
     * Acknowledge Order.
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantOrderAcknowledgementRequest $merchantOrderAcknowledgementRequest Relations between the id&#39;s returned by ChannelEngine and the references which the merchant uses. (optional)
     ...
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\OrderStatusView[] $statuses Order status(es) to filter on. AWAITING_PAYMENT orders will be excluded if it is not included in this Statuses filter. (optional)
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantOrderResponse
     */
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderGetByFilterWithHttpInfo($statuses = null, $emailAddresses = null, $merchantOrderNos = null, $channelOrderNos = null, $fromDate = null, $toDate = null, $fromCreatedAtDate = null, $toCreatedAtDate = null, $excludeMarketplaceFulfilledOrdersAndLines = null, $fulfillmentType = null, $onlyWithCancellationRequests = null, $channelIds = null, $stockLocationIds = null, $isAcknowledged = null, $fromUpdatedAtDate = null, $toUpdatedAtDate = null, $fromAcknowledgedDate = null, $toAcknowledgedDate = null, $page = null, string $contentType = self::contentTypes['orderGetByFilter'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantOrderResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantOrderResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantOrderResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantOrderResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * Update Comment.
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantOrderCommentUpdateRequest $merchantOrderCommentUpdateRequest merchantOrderCommentUpdateRequest (optional)
     ...
     * Update Comment.
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantOrderCommentUpdateRequest $merchantOrderCommentUpdateRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['orderUpdate'] to see the possible values for this operation
     *
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
