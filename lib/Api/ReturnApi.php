...
/**
     ...
     * Acknowledge Return.
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantReturnAcknowledgeRequest $merchantReturnAcknowledgeRequest merchantReturnAcknowledgeRequest (optional)
     ...
     * Acknowledge Return.
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantReturnAcknowledgeRequest $merchantReturnAcknowledgeRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['returnAcknowledge'] to see the possible values for this operation
     *
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create Return.
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantReturnRequest $merchantReturnRequest merchantReturnRequest (optional)
     ...
     * Create Return.
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantReturnRequest $merchantReturnRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['returnDeclareForMerchant'] to see the possible values for this operation
     *
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantSingleOrderReturnResponse
     */
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantSingleOrderReturnResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function returnGetByMerchantOrderNoWithHttpInfo($merchantOrderNo, string $contentType = self::contentTypes['returnGetByMerchantOrderNo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantSingleOrderReturnResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantSingleOrderReturnResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantSingleOrderReturnResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantSingleOrderReturnResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantSingleOrderReturnResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \FriendsOfCE\Channel\ApiClient\Model\ReturnStatus[] $statuses Return status(es) to filter on. (optional)
     * @param  \FriendsOfCE\Channel\ApiClient\Model\ReturnReason[] $reasons Return reason(s) to filter on. (optional)
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReturnResponse
     */
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReturnResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function returnGetDeclaredByChannelWithHttpInfo($channelIds = null, $merchantOrderNos = null, $channelOrderNos = null, $fulfillmentType = null, $statuses = null, $reasons = null, $fromDate = null, $toDate = null, $isAcknowledged = null, $page = null, string $contentType = self::contentTypes['returnGetDeclaredByChannel'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReturnResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReturnResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReturnResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReturnResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantReturnResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantReturnUpdateRequest $merchantReturnUpdateRequest merchantReturnUpdateRequest (optional)
     ...
     * Mark a return as received.
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantReturnUpdateRequest $merchantReturnUpdateRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['returnUpdateForMerchant'] to see the possible values for this operation
     *
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
