...
/**
     ...
     * @return \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductWithBuyBoxPrice|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse
     */
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductWithBuyBoxPrice|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function competitionPricesGetBuyBoxPricesWithHttpInfo($channelId = null, $gtinList = null, $skuList = null, $page = null, string $contentType = self::contentTypes['competitionPricesGetBuyBoxPrices'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductWithBuyBoxPrice' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductWithBuyBoxPrice' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductWithBuyBoxPrice', []),
            ...
            $returnType = '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductWithBuyBoxPrice';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductWithBuyBoxPrice',
