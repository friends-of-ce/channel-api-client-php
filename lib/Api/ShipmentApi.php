...
/**
     ...
     * Create Shipment.
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantShipmentRequest $merchantShipmentRequest merchantShipmentRequest (optional)
     ...
     * @return \FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse
     */
     ...
     * Create Shipment.
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantShipmentRequest $merchantShipmentRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['shipmentCreate'] to see the possible values for this operation
     *
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantChannelLabelShipmentRequest $merchantChannelLabelShipmentRequest The shipment to create (optional)
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse
     */
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantShipmentLabelCarrierRequest $merchantShipmentLabelCarrierRequest The parcel information (optional)
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentLabelCarrierResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse
     */
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentLabelCarrierResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function shipmentGetShipmentLabelCarriersWithHttpInfo($merchantOrderNo, $merchantShipmentLabelCarrierRequest = null, string $contentType = self::contentTypes['shipmentGetShipmentLabelCarriers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentLabelCarrierResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentLabelCarrierResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentLabelCarrierResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentLabelCarrierResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentLabelCarrierResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentResponse
     */
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function shipmentIndexWithHttpInfo($merchantShipmentNos = null, $merchantOrderNos = null, $method = null, $shippedFromCountryCodes = null, $fromShipmentDate = null, $toShipmentDate = null, $fromCreateDate = null, $toCreateDate = null, $fromUpdateDate = null, $toUpdateDate = null, $fulfillmentType = null, $channelShipmentNos = null, $channelOrderNos = null, $page = null, string $contentType = self::contentTypes['shipmentIndex'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantShipmentResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SplFileObject|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse
     */
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SplFileObject|\FriendsOfCE\Channel\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \FriendsOfCE\Channel\ApiClient\Model\MerchantShipmentTrackingRequest $merchantShipmentTrackingRequest The updated tracking information. (optional)
