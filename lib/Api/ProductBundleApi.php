...
/**
     ...
     * @return \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductBundleResponse
     */
     ...
     * @throws \FriendsOfCE\Channel\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductBundleResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productBundleGetByFilterWithHttpInfo($search = null, $eanList = null, $merchantProductNoList = null, $page = null, string $contentType = self::contentTypes['productBundleGetByFilter'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductBundleResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductBundleResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductBundleResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductBundleResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductBundleResponse',
