...
class MerchantProductRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'extraData' => '\FriendsOfCE\Channel\ApiClient\Model\MerchantProductExtraDataItemRequest[]',
        'name' => 'string',
        'description' => 'string',
        'brand' => 'string',
        'size' => 'string',
        ...
        'mSRP' => 'float',
        'purchasePrice' => 'float',
        'vatRateType' => '\FriendsOfCE\Channel\ApiClient\Model\VatRateType',
        'shippingCost' => 'float',
        'shippingTime' => 'string',
        'url' => 'string',
        'imageUrl' => 'string',
    ...
    */
     ...
     * Gets extraData
     *
     * @return \FriendsOfCE\Channel\ApiClient\Model\MerchantProductExtraDataItemRequest[]|null
     */
     ...
     * Sets extraData
     *
     * @param \FriendsOfCE\Channel\ApiClient\Model\MerchantProductExtraDataItemRequest[]|null $extraData An optional list of key-value pairs containing  extra data about this product. This data can be  sent to channels or used for filtering products.
     *
     * @return self
     */
     ...
     * Gets vatRateType
     *
     * @return \FriendsOfCE\Channel\ApiClient\Model\VatRateType|null
     */
     ...
     * Sets vatRateType
     *
     * @param \FriendsOfCE\Channel\ApiClient\Model\VatRateType|null $vatRateType vatRateType
     *
     * @return self
     */
