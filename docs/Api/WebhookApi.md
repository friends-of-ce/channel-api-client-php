# FriendsOfCE\Channel\ApiClient\WebhookApi
...
```php
webhooksCreate($merchantWebhookRequest): \FriendsOfCE\Channel\ApiClient\Model\ApiResponse
```
...
$apiInstance = new FriendsOfCE\Channel\ApiClient\Api\WebhookApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$merchantWebhookRequest = new \FriendsOfCE\Channel\ApiClient\Model\MerchantWebhookRequest(); // \FriendsOfCE\Channel\ApiClient\Model\MerchantWebhookRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **merchantWebhookRequest** | [**\FriendsOfCE\Channel\ApiClient\Model\MerchantWebhookRequest**](../Model/MerchantWebhookRequest.md)|  | [optional] |
...
```php
webhooksDelete($webhookName): \FriendsOfCE\Channel\ApiClient\Model\ApiResponse
```
...
```php
webhooksGetAll(): \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantWebhookResponse
```
...
[**\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantWebhookResponse**](../Model/CollectionOfMerchantWebhookResponse.md)
...
```php
webhooksUpdate($merchantWebhookRequest): \FriendsOfCE\Channel\ApiClient\Model\ApiResponse
```
