# FriendsOfCE\Channel\ApiClient\ProductApi
...
```php
productBulkDelete($requestBody): \FriendsOfCE\Channel\ApiClient\Model\ApiResponse
```
...
$apiInstance = new FriendsOfCE\Channel\ApiClient\Api\ProductApi(
...
```php
productBulkPatch($patchMerchantProductDto): \FriendsOfCE\Channel\ApiClient\Model\SingleOfProductCreationResult
```
...
$patchMerchantProductDto = new \FriendsOfCE\Channel\ApiClient\Model\PatchMerchantProductDto(); // \FriendsOfCE\Channel\ApiClient\Model\PatchMerchantProductDto | 1) PropertiesToUpdate: Fields to update<br />2) MerchantProductRequestModels: Products to be updated
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **patchMerchantProductDto** | [**\FriendsOfCE\Channel\ApiClient\Model\PatchMerchantProductDto**](../Model/PatchMerchantProductDto.md)| 1) PropertiesToUpdate: Fields to update&lt;br /&gt;2) MerchantProductRequestModels: Products to be updated | [optional] |

### Return type

[**\FriendsOfCE\Channel\ApiClient\Model\SingleOfProductCreationResult**](../Model/SingleOfProductCreationResult.md)
...
```php
productBulkPatchExtraDataItems($merchantProductExtraDataRequest): \FriendsOfCE\Channel\ApiClient\Model\SingleOfProductCreationResult
```
...
$merchantProductExtraDataRequest = array(new \FriendsOfCE\Channel\ApiClient\Model\MerchantProductExtraDataRequest()); // \FriendsOfCE\Channel\ApiClient\Model\MerchantProductExtraDataRequest[]
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **merchantProductExtraDataRequest** | [**\FriendsOfCE\Channel\ApiClient\Model\MerchantProductExtraDataRequest[]**](../Model/MerchantProductExtraDataRequest.md)|  | [optional] |
...
```php
productCreate($merchantProductRequest, $ignoreStock): \FriendsOfCE\Channel\ApiClient\Model\SingleOfProductCreationResult
```
...
$merchantProductRequest = array(new \FriendsOfCE\Channel\ApiClient\Model\MerchantProductRequest()); // \FriendsOfCE\Channel\ApiClient\Model\MerchantProductRequest[]
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **merchantProductRequest** | [**\FriendsOfCE\Channel\ApiClient\Model\MerchantProductRequest[]**](../Model/MerchantProductRequest.md)|  | |
...
```php
productDelete($merchantProductNo): \FriendsOfCE\Channel\ApiClient\Model\ApiResponse
```
...
```php
productGetByFilter($search, $eanList, $merchantProductNoList, $page): \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductResponse
```
...
[**\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductResponse**](../Model/CollectionOfMerchantProductResponse.md)
...
```php
productGetByMerchantProductNo($merchantProductNo): \FriendsOfCE\Channel\ApiClient\Model\SingleOfMerchantProductResponse
```
...
[**\FriendsOfCE\Channel\ApiClient\Model\SingleOfMerchantProductResponse**](../Model/SingleOfMerchantProductResponse.md)
...
```php
productPatch($merchantProductNo, $operation): \FriendsOfCE\Channel\ApiClient\Model\SingleOfProductCreationResult
```
...
```php
productPatchExtraDataItems($merchantProductExtraDataRequest): \FriendsOfCE\Channel\ApiClient\Model\SingleOfProductCreationResult
```
...
$merchantProductExtraDataRequest = new \FriendsOfCE\Channel\ApiClient\Model\MerchantProductExtraDataRequest(); // \FriendsOfCE\Channel\ApiClient\Model\MerchantProductExtraDataRequest
