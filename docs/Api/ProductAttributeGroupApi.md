# FriendsOfCE\Channel\ApiClient\ProductAttributeGroupApi
...
```php
productAttributeGroupAddProductExtraData($groupName, $addProductExtraDataRequests): \FriendsOfCE\Channel\ApiClient\Model\ApiResponse
```
...
$apiInstance = new FriendsOfCE\Channel\ApiClient\Api\ProductAttributeGroupApi(
...
$addProductExtraDataRequests = new \FriendsOfCE\Channel\ApiClient\Model\AddProductExtraDataRequests(); // \FriendsOfCE\Channel\ApiClient\Model\AddProductExtraDataRequests | Product extra data keys to be added.
...
| **addProductExtraDataRequests** | [**\FriendsOfCE\Channel\ApiClient\Model\AddProductExtraDataRequests**](../Model/AddProductExtraDataRequests.md)| Product extra data keys to be added. | [optional] |
...
```php
productAttributeGroupCreate($productAttributeGroupRequest): \FriendsOfCE\Channel\ApiClient\Model\ApiResponse
```
...
$productAttributeGroupRequest = array(new \FriendsOfCE\Channel\ApiClient\Model\ProductAttributeGroupRequest()); // \FriendsOfCE\Channel\ApiClient\Model\ProductAttributeGroupRequest[] | Collection of product attribute groups with linked product extra data keys.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **productAttributeGroupRequest** | [**\FriendsOfCE\Channel\ApiClient\Model\ProductAttributeGroupRequest[]**](../Model/ProductAttributeGroupRequest.md)| Collection of product attribute groups with linked product extra data keys. | |
...
```php
productAttributeGroupDelete($groupName): \FriendsOfCE\Channel\ApiClient\Model\ApiResponse
```
...
```php
productAttributeGroupGetByFilter($groupNames, $page): \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductAttributeGroupWithProductExtraDataResponse
```
...
[**\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductAttributeGroupWithProductExtraDataResponse**](../Model/CollectionOfMerchantProductAttributeGroupWithProductExtraDataResponse.md)
...
```php
productAttributeGroupGetWithChannelsByFilter($groupNames, $page): \FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductAttributeGroupWithLinkedChannelsResponse
```
...
[**\FriendsOfCE\Channel\ApiClient\Model\CollectionOfMerchantProductAttributeGroupWithLinkedChannelsResponse**](../Model/CollectionOfMerchantProductAttributeGroupWithLinkedChannelsResponse.md)
...
```php
productAttributeGroupRemoveProductExtraData($groupName, $removeProductExtraDataRequests): \FriendsOfCE\Channel\ApiClient\Model\ApiResponse
```
...
$removeProductExtraDataRequests = new \FriendsOfCE\Channel\ApiClient\Model\RemoveProductExtraDataRequests(); // \FriendsOfCE\Channel\ApiClient\Model\RemoveProductExtraDataRequests | Product extra data keys to be removed.
...
| **removeProductExtraDataRequests** | [**\FriendsOfCE\Channel\ApiClient\Model\RemoveProductExtraDataRequests**](../Model/RemoveProductExtraDataRequests.md)| Product extra data keys to be removed. | [optional] |
...
```php
productAttributeGroupRenameProductAttributeGroup($renameProductAttributeGroupRequests): \FriendsOfCE\Channel\ApiClient\Model\ApiResponse
```
...
$renameProductAttributeGroupRequests = array(new \FriendsOfCE\Channel\ApiClient\Model\RenameProductAttributeGroupRequests()); // \FriendsOfCE\Channel\ApiClient\Model\RenameProductAttributeGroupRequests[] | List of old and new product attribute group names.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **renameProductAttributeGroupRequests** | [**\FriendsOfCE\Channel\ApiClient\Model\RenameProductAttributeGroupRequests[]**](../Model/RenameProductAttributeGroupRequests.md)| List of old and new product attribute group names. | [optional] |
