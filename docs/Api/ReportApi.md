# FriendsOfCE\Channel\ApiClient\ReportApi
...
```php
reportCreateSettlementsReport($merchantCreateSettlementsReportRequest): \FriendsOfCE\Channel\ApiClient\Model\MerchantCreateReportResponse
```
...
$apiInstance = new FriendsOfCE\Channel\ApiClient\Api\ReportApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$merchantCreateSettlementsReportRequest = new \FriendsOfCE\Channel\ApiClient\Model\MerchantCreateSettlementsReportRequest(); // \FriendsOfCE\Channel\ApiClient\Model\MerchantCreateSettlementsReportRequest | To provide settlementIds and type of report SUMMARY or DETAILED.
...
| ------------- | ------------- | ------------- | ------------- |
| **merchantCreateSettlementsReportRequest** | [**\FriendsOfCE\Channel\ApiClient\Model\MerchantCreateSettlementsReportRequest**](../Model/MerchantCreateSettlementsReportRequest.md)| To provide settlementIds and type of report SUMMARY or DETAILED. | |

### Return type

[**\FriendsOfCE\Channel\ApiClient\Model\MerchantCreateReportResponse**](../Model/MerchantCreateReportResponse.md)
...
```php
reportGetStatus($reportId): \FriendsOfCE\Channel\ApiClient\Model\MerchantGetReportStatusResponse
```
...
[**\FriendsOfCE\Channel\ApiClient\Model\MerchantGetReportStatusResponse**](../Model/MerchantGetReportStatusResponse.md)
